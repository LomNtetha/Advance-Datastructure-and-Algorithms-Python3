...
"""
Write a Python function that takes a list of digits as input and generates all possible permutations of the digits.
Each permutation should be printed as a space-separated string.
"""
...
"""
Write a Python script that takes a list containing a mix of strings and nested lists as input. Using itertools.combinations,
generate and print all possible 2-element combinations from the list. Each combination should be labeled with its index number.
"""
