...
"""
10. You are given two strings s and t where t is generated by shuffling the string s and adding one more letter at a random position.
...
class Solution:
    def firstUniqChar(self, s: str) -> int:
        ...
        # Step 2: Iterate through the string and find the first character with a count of 1
...
"""
14. A string frequency problem involves counting the frequency of characters or words in a given string and performing operations
...
each character and its frequency, sorted by frequency in descending order. If two characters have the same frequency,
...
"""
15. Given two lists list1 and list2, find the common interest with the least index sum. If there is a tie, return all such common interests.
...
"""
16. Write an algorithm to determine if a number is "happy." A happy number is a number that eventually reaches 1 when replaced
